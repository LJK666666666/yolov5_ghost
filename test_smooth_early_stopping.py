...
def simulate_training_scenario(scenario_name, fitness_values, patience=30, window_size=10):
    ...
    print("Epoch | Fitness  | Std Stop | Smooth Avg | Smooth Stop")
    print("-" * 55)
    ...
    for epoch, fitness in enumerate(fitness_values):
        ...
        print(
            f"{epoch:5d} | {fitness:8.4f} | {std_status:8s} | {status['current_avg_fitness']:10.4f} | {smooth_status:11s}"
        )
