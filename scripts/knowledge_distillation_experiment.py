#!/usr/bin/env python3
"""
知识蒸馏对比实验脚本 创新亮点四：引入"知识蒸馏"提升小模型性能.

使用方法： python scripts/knowledge_distillation_experiment.py --mode [baseline|distill|compare|test|all]
"""
...
def test_teacher_model():
    ...
    try:
        ...
        with open(ROOT / "data/SafetyVests.v6/data.yaml") as f:
...
def main():
    ...
    parser.add_argument(
        "--mode", choices=["baseline", "distill", "compare", "test", "all"], default="test", help="实验模式"
    )
