...
使用方法：
python scripts/weighted_feature_fusion_experiment.py --mode [baseline|wff|wff_concat|compare|all]
"""
...
def main():
    ...
    parser.add_argument("--mode", choices=["baseline", "wff", "wff_concat", "compare", "test", "all"], 
